...
// A new component to handle the main layout for authenticated users
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        {/* The Outlet component will render the nested route's element (e.g., Dashboard or WishlistPage) */}
        <Outlet />
      </main>
    </div>
  );
...
// A new component to protect routes that require authentication
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        >
          {/* Nested routes that will be rendered inside AppLayout */}
          <Route index element={<Dashboard />} />
          <Route path="wishlist/:id" element={<WishlistPage />} />
        </Route>

        {/* A fallback for any other path, redirecting home */}
